...
public class WeizhangActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		weizhangIntent.putExtra("appId",2403);// 您的appId
		weizhangIntent.putExtra("appKey", "8baaee00ff89445e4294360d0fbd0111");// 您的appKey
		...
		if (car.getCity_id() > 0) {
			...
			if (classno > 0) {
				...
				if (car.getChejia_no().length() != classno) {
					Toast.makeText(WeizhangActivity.this, "输入车架号后" + classno + "位",
							0).show();
					return false;
				}
			} else if (classno < 0) {
